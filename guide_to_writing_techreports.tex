...
\item Don't data that can fit into a small table (typically, use the  representation that takes less space).
...
\item A heading ``Synopsis'', followed by the synopsis of 100 to
  200 words.
